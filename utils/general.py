# YOLOR general yolov7 https://github.com/WongKinYiu/yolov7/blob/main/utils/plots.py
...
def check_dataset(dict):
    # Download datasets if not found locally
...
def labels_to_class_weights(labels, nc=80):
    ...
    if labels.shape[1] > 5: # bdc logits
        labels[:, 4] = labels[:, 5:].argmax(axis=1)
    classes = labels[:, 4].astype(np.int32)  # labels = [xyxy cls]
